...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setIsLoading(true);
    const success = await register({ name, email, phone, password, type: "customer" });
    setIsLoading(false);
      ...
      <main className="flex items-center justify-center py-16 px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">Join ServiConnect as a customer</p>
          </div>
          ...
          <div className="bg-card rounded-2xl p-6 border border-border shadow-md">
            ...
            <Link to="/auth/vendor-register" className="flex items-center justify-center gap-2 text-primary hover:underline">
