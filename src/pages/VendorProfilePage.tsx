...
import { getVendorById, getReviewsByVendor, getServiceById } from "@/data/services";
                    ...
                    <div className="flex flex-col gap-2 w-full md:w-auto">
                      {vendor.isAvailable && (
                        <Button asChild variant="hero" size="lg">
                          <Link
                            to={`/request/${vendor.id}${serviceId ? `?service=${serviceId}` : ""}`}
                          >
                            Request Service
                          </Link>
                        </Button>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-card rounded-2xl p-6 border border-border sticky top-24">
                  ...
                  <p className="text-2xl font-bold text-primary">{vendor.priceRange}</p>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      ...
                      <span className="font-medium text-primary">{vendor.phone}</span>
                    </a>
                  </div>
