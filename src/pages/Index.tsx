...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Get connected with available vendors within minutes of your request.",
    },
    {
      icon: Star,
      title: "Quality Guaranteed",
      description: "Read reviews and ratings to choose the best service provider.",
    },
    {
      icon: CheckCircle2,
      title: "Transparent Pricing",
      description: "Know the price range upfront. No hidden charges or surprises.",
    },
  ];
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: "100ms" }}>
                Connect with verified professionals for home repairs, appliance services, 
                vehicle care, and more. Quality service, guaranteed.
              </p>
              ...
              {/* Quick Actions */}
              <div className="flex flex-wrap justify-center gap-4 mt-8 animate-slide-up" style={{ animationDelay: "300ms" }}>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                From home repairs to vehicle services, find the right professional for every need.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                Trusted professionals with excellent reviews from our community.
              </p>
            </div>
        ...
        <section className="py-16 lg:py-20 bg-gradient-primary">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-primary-foreground/90 text-lg max-w-2xl mx-auto mb-8">
              Join ServiConnect and grow your business. Reach thousands of customers 
